...
const Search = () => {
    return (
        <div className="border border-black flex items-center rounded-lg bg-gray-100">
            <input type="text" className="mx-2 pl-3 p-1 bg-gray-100 border border-transparent focus:outline-none focus:border-transparent" placeholder="What are you looking for?" />
            <span className="mr-4"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
